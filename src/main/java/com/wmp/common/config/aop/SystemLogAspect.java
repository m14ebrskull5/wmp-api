package com.wmp.common.config.aop;
...
import com.wmp.common.util.DateUtils;
import com.wmp.common.util.JacksonUtils;
import com.wmp.common.util.StringUtils;
...
public class SystemLogAspect {
	...
	private static final ThreadLocal<Card> currentUser = new NamedThreadLocal<>("ThreadLocal user");
	 ...
	 * @throws
	 */
	private Card getCurrentUser(HttpServletRequest request) {
		HttpSession session = request.getSession();
		Card user = (Card) session.getAttribute(SESSION_USER_KEY);
		return user;
	}
